...
def main():
    ...
    for dir_entry in os.scandir("providers"):
        ...
        version = wanted_version(os.path.join(dir_entry.path, dir_entry.name + ".tf"))
        ...
        if not provider_schemas:
            ...
            if json_schema_bytes:
                ...
                schema_filename = os.path.join(dir_entry.path, f"schema-{version}.json")
